...
--
-- Host: localhost
-- Generation Time: 28.02.2025 klo 09:25
-- Palvelimen versio: 10.6.18-MariaDB-0ubuntu0.22.04.1
-- PHP Version: 8.2.1
...
CREATE TABLE `tuotteet` (
  ...
  `varastomaara` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tuotteet` (`id`, `nimi`, `nimi_en`, `kuvaus`, `kuvaus_en`, `hinta`, `kuva`, `varastomaara`) VALUES
