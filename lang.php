...
$lang = [
    ...
    'fi' => [
        ...
        'UserDetails' => 'Käyttäjätietosi',
        'back' => 'Takaisin profiiliin',
        'EditPageInfo' => 'Tällä sivulla voit päivittää omat käyttäjätietosi.',
        'Save2' => 'Tallenna muutokset',
        'pwdchangemsg' => 'Syötä uusi salasana:',
        'pwdchange' => 'Vaihda salasana',
        'editalert1' => 'Päivitä tietosi vaihtamalla niitä.',
        'editalert2' => 'Muutokset tallennettu onnistuneesti!',
        'editalert3' => 'Virhe tiedon syötössä.',
        'editalert4' => 'Virhe SQL lauseessa: ',
        'pwdalert1' => 'Salasana ei saa olla tyhjä.',
        'pwdalert2' => 'Salasana päivitetty onnistuneesti!',
